...
JOIN store_customers sc ON fc.c_customer_sk = sc.customer_sk
JOIN web_or_catalog_customers wcc ON fc.c_customer_sk = wcc.customer_sk
WHERE cd.cd_marital_status IN ('M',
                            'U',
                            'U')
