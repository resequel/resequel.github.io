...
WHERE NOT EXISTS
    (SELECT 1
     ...
     WHERE sc.c_last_name = c2.c_last_name
       AND sc.c_first_name = c2.c_first_name
       AND sc.d_date = d2.d_date
  ...
  AND NOT EXISTS
    (SELECT 1
     ...
     WHERE sc.c_last_name = c3.c_last_name
       AND sc.c_first_name = c3.c_first_name
       AND sc.d_date = d3.d_date
       ...
       AND ws.ws_wholesale_cost BETWEEN 90 AND 100);