...
CREATE TEMP TABLE ss_quarterly_sales AS
SELECT ca_county,
       d_qoy,
       d_year,
...
CREATE TEMP TABLE ws_quarterly_sales AS
SELECT ca_county,
       d_qoy,
       d_year,
...
FROM ss_quarterly_sales ss1,
     ss_quarterly_sales ss2,
     ss_quarterly_sales ss3,
     ws_quarterly_sales ws1,
     ws_quarterly_sales ws2,
     ws_quarterly_sales ws3
WHERE ss1.d_qoy = 1
  AND ss1.d_year = 2001
