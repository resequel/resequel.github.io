WITH sr_items AS
  (SELECT i_item_id item_id,
   ...
   WHERE d_month_seq IN
     ...
     AND sr_return_amt BETWEEN sr_return_quantity * 141 AND sr_return_quantity * 170
  ...
  (SELECT i_item_id item_id,
   ...
   WHERE d_month_seq IN
     ...
     AND i_category IN ('Books',
                        'Sports')
     AND i_manager_id BETWEEN 36 AND 45
     AND cr_return_amount BETWEEN cr_return_quantity * 141 AND cr_return_quantity * 170
  ...
  (SELECT i_item_id item_id,
   ...
   WHERE d_month_seq IN
     ...
     AND i_category IN ('Books',
                        'Sports')
     AND i_manager_id BETWEEN 36 AND 45
     AND wr_return_amt BETWEEN wr_return_quantity * 141 AND wr_return_quantity * 170
