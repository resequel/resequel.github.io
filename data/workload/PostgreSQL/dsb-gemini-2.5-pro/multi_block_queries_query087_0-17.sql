   ...
   WHERE d.d_month_seq BETWEEN 1222 AND 1222+11
     ...
     AND NOT EXISTS
       (SELECT 1
        ...
        WHERE c.c_last_name = c2.c_last_name
          AND c.c_first_name = c2.c_first_name
          AND d.d_date = d2.d_date
     ...
     AND NOT EXISTS
       (SELECT 1
        ...
        WHERE c.c_last_name = c3.c_last_name
          AND c.c_first_name = c3.c_first_name
          AND d.d_date = d3.d_date
