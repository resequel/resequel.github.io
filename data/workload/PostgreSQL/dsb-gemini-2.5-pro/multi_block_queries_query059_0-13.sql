  ...
  (SELECT CASE
          ...
          sum(CASE
                  WHEN d.d_day_name = 'Sunday'
                     ...
                     'OH',
                     'OR',
                     'TX') THEN ss_sales_price
              END) AS sun_sales1,
          sum(CASE
                  WHEN d.d_day_name = 'Monday'
                       AND d.d_month_seq BETWEEN 1207 AND 1207 + 11
                       AND s.s_state IN ('GA',
                     'IL',
                     'IN',
