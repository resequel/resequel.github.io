WITH base_data AS MATERIALIZED
  (SELECT ws.ws_quantity, ws.ws_sales_price, ws.ws_net_profit, wr.wr_refunded_cash, wr.wr_fee, r.r_reason_desc, cd1.cd_marital_status AS cd1_ms, cd1.cd_education_status AS cd1_es, cd2.cd_marital_status AS cd2_ms, cd2.cd_education_status AS cd2_es, ca.ca_country, ca.ca_state
   FROM web_sales ws
