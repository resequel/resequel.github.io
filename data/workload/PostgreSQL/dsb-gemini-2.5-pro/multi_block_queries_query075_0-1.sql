WITH sales_details AS
  (SELECT d.d_year,
   ...
   WHERE d.d_year IN (1999, 1999 - 1)
     ...
     AND cs.cs_sales_price BETWEEN cs.cs_list_price * (80 * 0.01) AND cs.cs_list_price * (100 * 0.01)
   ...
   WHERE d.d_year IN (1999, 1999 - 1)
     AND i.i_category = 'Sports'
     AND ws.ws_sales_price BETWEEN ws.ws_list_price * (80 * 0.01) AND ws.ws_list_price * (100 * 0.01))
