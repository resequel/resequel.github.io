WITH relevant_dates AS
  ...
  (SELECT d.d_year,
   ...
   JOIN relevant_dates d ON d.d_date_sk = cs.cs_sold_date_sk
   ...
   JOIN relevant_dates d ON d.d_date_sk = ss.ss_sold_date_sk
   ...
   JOIN relevant_dates d ON d.d_date_sk = ws.ws_sold_date_sk
