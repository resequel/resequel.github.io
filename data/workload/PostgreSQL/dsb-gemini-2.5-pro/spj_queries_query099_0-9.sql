...
JOIN filtered_warehouses AS w ON cs.cs_warehouse_sk = w.w_warehouse_sk
JOIN filtered_ship_modes AS sm ON cs.cs_ship_mode_sk = sm.sm_ship_mode_sk
JOIN filtered_call_centers AS cc ON cs.cs_call_center_sk = cc.cc_call_center_sk
