...
WHERE d_year = 1998
  ...
  AND CASE
          WHEN (cd1.cd_marital_status,
                cd1.cd_education_status) = ('W', '2 yr Degree') THEN ws_sales_price BETWEEN 100.00 AND 150.00
          WHEN (cd1.cd_marital_status,
                cd1.cd_education_status) = ('S', 'College') THEN ws_sales_price BETWEEN 50.00 AND 100.00
          WHEN (cd1.cd_marital_status,
                cd1.cd_education_status) = ('D', 'Advanced Degree') THEN ws_sales_price BETWEEN 150.00 AND 200.00
          ELSE FALSE
      END
