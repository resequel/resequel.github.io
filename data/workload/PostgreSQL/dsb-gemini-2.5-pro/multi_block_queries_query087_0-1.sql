   ...
   FROM
     (SELECT DISTINCT c.c_last_name,
      ...
      WHERE d.d_month_seq BETWEEN 1222 AND 1222+11
        ...
        AND ss_wholesale_cost BETWEEN 90 AND 100) sc
   LEFT JOIN
     (SELECT DISTINCT c.c_last_name,
                      c.c_first_name,
                      d.d_date
      ...
      WHERE d.d_month_seq BETWEEN 1222 AND 1222+11
        ...
        AND c.c_birth_year BETWEEN 1958 AND 1964
        AND cs_wholesale_cost BETWEEN 90 AND 100) cc ON sc.c_last_name = cc.c_last_name
   ...
   LEFT JOIN
     (SELECT DISTINCT c.c_last_name,
      ...
      WHERE d.d_month_seq BETWEEN 1222 AND 1222+11
        ...
        AND c.c_birth_year BETWEEN 1958 AND 1964
        AND ws_wholesale_cost BETWEEN 90 AND 100) wc ON sc.c_last_name = wc.c_last_name
