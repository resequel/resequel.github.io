WITH month_seqs AS
  ...
  (SELECT i.i_item_id AS item_id,
   ...
   FROM store_sales ss
   JOIN f_date_ss d ON ss.ss_sold_date_sk = d.d_date_sk
  ...
  (SELECT i.i_item_id AS item_id,
   ...
   JOIN f_date_cs d ON cs.cs_sold_date_sk = d.d_date_sk
  ...
  (SELECT i.i_item_id AS item_id,
   ...
   FROM web_sales ws
   JOIN f_date_ws d ON ws.ws_sold_date_sk = d.d_date_sk
